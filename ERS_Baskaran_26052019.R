...
#My Github repository: https://github.com/tbaskaran/edX-Capstone-CYO-Project
#If the RMd file is used for knitting to Word file, then first download the Word ferefence file using the following code: 
#download.file("https://github.com/tbaskaran/edX-Capstone-CYO-Project/raw/master/Word_Style_Reference.docx","Word_Style_Reference.docx")
